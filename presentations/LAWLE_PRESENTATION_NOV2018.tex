...
\begin{column}{0.5\textwidth}  %%<--- here
  \begin{figure}[H]
    ...
    \begin{center}
        \includegraphics[width=0.75\textwidth]{calctreat_p2.pdf}
        \end{center}
\end{figure} 
\end{column}
\end{columns}
...
\caption{SS}
\begin{center}
\tiny{\input{../pilot_3/Tables/SS_pres.tex}}
\end{center}
 \footnotesize
...
\caption{SS}
\begin{center}
\tiny{\input{../pilot_3/Tables/SS_pres_main_outcomes.tex}}
\end{center}
 \footnotesize
\textit{Notes:} Summary statistics of main variables. Standard errors are shown in parenthesis.   
\textit{Do file: } \texttt{SS.do}
...
\begin{frame}{A/B Results}
 ...
 \begin{subtable}{1.\textwidth}
 \begin{center}
 \tiny{\input{../pilot_3/Tables/reg_ab_pres.tex}}
 \end{center}
 \end{subtable}
 \end{table}  
...
\begin{frame}{Causal Results - Correcting for Endogeneity}
 ...
 \begin{subtable}{1.\textwidth}
 \begin{center}
 \tiny{\input{../pilot_3/Tables/iv_cf_pl_sue_pres.tex}}
 \end{center}
 \end{subtable}
 \end{table}  
...
\begin{frame}{Talking to any lawyer induces less settlement}
 ...
 \begin{subtable}{1.\textwidth}
 \begin{center}
 \tiny{\input{../pilot_3/Tables/iv_cf_plnocond_sue_pres.tex}}
 \end{center}
 \end{subtable}
 \end{table}  
...
\begin{frame}{Talking to any lawyer induces less settlement}
 ...
 \begin{subtable}{1.\textwidth}
 \begin{center}
 \tiny{\input{../pilot_3/Tables/talked_sett.tex}}
 \end{center}
 \end{subtable}
 \end{table}  
...
% \begin{subtable}{1.\textwidth}
% \begin{center}
% \tiny{\input{../pilot_3/Tables/welfare%_reg_2m_pres.tex}}
% \end{center}
% \end{subtable}
% \end{table}  
...
%\begin{frame}{Lawyer's Quality}
    ...
    %\begin{center}
        ...
        %    \centering
            %\includegraphics[width=\tex%twidth]{betas_pos_rec.pdf}
        %\end{subfigure}
        %\begin{subfigure}{0.49\textwidt%h}
       % \caption{Duration}
             %   \centering
                %\includegraphics[width=%\textwidth]{betas_durat%ion.pdf}
        %\end{subfigure}
    %\end{center} 
%\end{figure} 
%\end{frame}
