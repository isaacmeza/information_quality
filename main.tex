...
\begin{table}[!ht]
    ...
    \label{tab:SS}
    \center
    \scriptsize{\input{./Tables_E2L/Table1_SS.tex}}
...
\begin{table}[!ht]
    ...
    \label{tab:2_pred}
    \center
    \notesize{\input{./Tables_E2L/Table2.tex}}
    \begin{figurenotes}
...
\begin{table}[!ht]
    ...
    \label{tab:3}
    \center
    \notesize{\input{./Tables_E2L/Table3.tex}}
    \begin{figurenotes}
...
\begin{table}[!ht]
    ...
    \label{tab:4}
    \center
    \notesize{\input{./Tables_E2L/Table4.tex}}
    \begin{figurenotes}
...
\begin{table}[H]
    ...
    \begin{center}
    \scriptsize{\input{./Tables/te_updating.tex}}
    \end{center}
...
\begin{table}[!ht]
    ...
    \begin{center}
    \footnotesize{\input{./Tables/te_main_outcomes.tex}}
    \end{center}
...
\begin{table}[!ht]
    ...
    \label{tab:8}
    \center
    \notesize{\input{./Tables_E2L/Table8.tex}}
    \begin{figurenotes}
...
\begin{table}[!ht]
    ...
    \center
    \scriptsize{\input{./Tables_E2L/Table9_lawyer_uncond.tex}}
    \begin{figurenotes}
...
\begin{table}[!ht]
    ...
    \center
    \scriptsize{\input{./Tables_E2L/Table10_TE_quality.tex}}
