...
save "$directorio\_aux\treatment_data.dta", replace
...
*									  2W			   				  		   *
********************************************************************************
do "$directorio\DoFiles\cleaning_2w_survey.do"
...
*									  2M			   				  		   *
********************************************************************************
do "$directorio\DoFiles\cleaning_2m_survey.do"
...
*									  TD							  		   *
********************************************************************************
use "$directorio\_aux\treatment_data.dta", clear


*Join nivel_educativo
merge 1:1 id_actor using "$directorio\DB\survey_data_2w.dta", nogen keep(1 3) keepusing(id_actor grado_de_estudios)
...
*						     	Base informatica					  		   *
********************************************************************************
do "$directorio\DoFiles\expedientes_cleaning.do"

*Name cleaning
do "$directorio\DoFiles\clean_exact_match.do"
global threshold_similscore = 0.94
do "$directorio\DoFiles\clean_fuzzy_match.do"
