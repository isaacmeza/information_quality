...
eststo: reg bajo_inm i.main_treatment##i.high_tenure mujer  salario_diario ///
...
*************************
	esttab using "$directorio/Tables/reg_results/update_treatment_high_tenure.csv", se star(* 0.1 ** 0.05 *** 0.01) b(a2) r2 ///
