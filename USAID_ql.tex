...
\begin{table}[H]
    ...
    \label{betas_cor}
     \begin{center}
    \scriptsize{\input{./Tables/betas_cor.tex}}
    \end{center}
  \scriptsize{ \noindent 
    \textit{Do file: }  \texttt{fe\_quality\_betas.do}}
\end{table}
...
\begin{table}[H]
    ...
    \label{scores_cor}
     \begin{center}
    \scriptsize{\input{./Tables/scores_cor.tex}}
    \end{center}
  \scriptsize{ \noindent 
...
\begin{table}[H]
    ...
    \begin{center}
    \scriptsize{\input{./Tables/total_cor_reshape.tex}}
    \end{center}
  \scriptsize{ \noindent 
    \textit{Do file: }  \texttt{laywer\_scores\_p3\_f.do}}
\end{table}
...
\begin{table}[H]
    ...
    \label{icc_cor}
    \begin{center}
    \scriptsize{\input{./Tables/total_cor.tex}}
    \end{center}
  \scriptsize{ \noindent 
    \textit{Do file: }  \texttt{laywer\_scores\_p3\_f.do}}
\end{table}
